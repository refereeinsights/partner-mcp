...
export const TOOLS = [
  ...
  { name: "find_production_matches", category: "tournament_discovery", access: "read", description: "Batch duplicate lookup: pass up to 25 candidate descriptors, get production matches for each in one call. Use to classify search-history findings as New / Duplicate / Enrichment." },
